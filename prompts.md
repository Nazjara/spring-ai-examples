...
Tests to see if the model can write a more complex python script.
...
Many models only can look ahead and will fail this test.
...
More complex problem to test the model's logic and reasoning. Many models will answer that the ball is in the
...
Provides the model with additional details about the cup's orientation not changing. Many will still fail this test.
